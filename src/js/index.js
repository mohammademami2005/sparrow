...
hamburgerMenuToggle.addEventListener("click", function () {
  ...
  if (hamburgerMenuImg.getAttribute("src") === "/src/assets/images/team/image.png") {
    setTimeout(() => {
      hamburgerMenuImg.setAttribute("src", "/src/assets/images/image.png");
    }, 500);
  } else {
    setTimeout(() => {
      hamburgerMenuImg.setAttribute("src", "/src/assets/images/team/image.png");
    }, 900);
  }
});
